...
resource "azurerm_bastion_host" "hub" {
  ...
  file_copy_enabled         = var.hub_bastion.sku_name == "Basic" ? false : var.hub_bastion.features.file_copy_enabled
  tunneling_enabled         = var.hub_bastion.sku_name == "Basic" ? false : var.hub_bastion.features.tunneling_enabled
  shareable_link_enabled    = var.hub_bastion.sku_name == "Basic" ? false : var.hub_bastion.features.shareable_link_enabled
  kerberos_enabled          = var.hub_bastion.sku_name == "Basic" ? false : var.hub_bastion.features.kerberos_enabled
  ip_connect_enabled        = var.hub_bastion.sku_name == "Basic" ? false : var.hub_bastion.features.ip_connect_enabled
  session_recording_enabled = var.hub_bastion.sku_name == "Basic" ? false : var.hub_bastion.features.session_recording_enabled
}
